...
HD_PWD='D:/INDICUS/Projects/V_Projects/FSM/rr_arbiter/rr_arbiter/rr_arbiter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rr_arbiter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rr_arbiter.tcl -notrace
